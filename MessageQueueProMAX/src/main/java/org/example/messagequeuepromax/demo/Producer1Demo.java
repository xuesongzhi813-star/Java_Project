...
public class Producer1Demo {
    public static void main(String[] args) throws IOException, mqException, InterruptedException {
        ...
        Channel channel=connection.createChannel("producer1User","123456");

        //此时已经注册过，采取直接登录
//        if(!channel.register("producer1User","123456")){
//            channel.login("producer1User","123456");
//        }
